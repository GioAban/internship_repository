                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            <div className="overflow-x-auto">
                                <div className="mb-3">
                                    <Link href={route("category.create")} className="btn btn-soft btn-sm w-full">Add</Link>
                                </div>
                                                ...
                                                <tr key={row.id} className="border ps-2">
                                                    ...
                                                    <td className="border ps-2">
                                                        <div className="flex justify-end">
                                                            <Link href={"/category/" + row.id} className="btn btn-soft btn-sm mx-1">View</Link>
                                                            <Link href={"/edit-category/" + row.id} className="btn btn-soft btn-sm mx-1">Edit</Link>
                                                        </div>
                                                    </td>
                                                </tr>
                                            ))}
